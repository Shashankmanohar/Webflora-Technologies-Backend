...
const navItems = [
  ...
  { link: "/school/class", label: "Class", icon: ClipboardList },
  { link: "/school/subject", label: "Subject", icon: BookOpen },
  { link: "/school/student", label: "Student", icon: Users },
  { link: "/school/teacher", label: "Teacher", icon: Users },
  { link: "/school/notice", label: "Notice", icon: Bell },
  { link: "/school/schedule", label: "Schedule", icon: Calendar },
  { link: "/school/examination", label: "Examination", icon: ClipboardList },
  { link: "/school/attendance", label: "Attendance", icon: BarChart },
];
    ...
    <div className="flex h-screen">
      ...
      <div className={cn(
        ...
        <div className="flex items-center justify-between p-4">
          <h1 className={cn("text-lg font-semibold", !open && "hidden")}>Menu</h1>
      ...
      <div className="flex-1 flex flex-col bg-[#1B1C30]">
        ...
        <div className="bg-[#0D0E22] shadow p-4 flex items-center">
          ...
          <h2 className="text-xl text-white  font-semibold">School Management</h2>
        </div>
        {/* Page Content */}
