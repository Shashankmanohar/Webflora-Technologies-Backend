...
const navItems = [
  ...
  { link: "/student/notice", label: "Notice", icon: Bell },
  { link: "/student/schedule", label: "Schedule", icon: Calendar },
  { link: "/student/examination", label: "Examination", icon: ClipboardList },
  { link: "/student/attendance", label: "Attendance", icon: BarChart },
];
